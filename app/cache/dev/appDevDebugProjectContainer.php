...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'preFlush'), new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.app.usuarios'), $this->get('fos_elastica.indexable'), array('identifier' => 'id', 'indexName' => 'app', 'typeName' => 'usuarios'), NULL));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'acceso', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setEntityNamespaces(array('AdminBundle' => 'Proyecto\\AdminBundle\\Entity', 'DeportesBundle' => 'Proyecto\\DeportesBundle\\Entity', 'ActivosBundle' => 'Proyecto\\ActivosBundle\\Entity', 'EnfermeriaBundle' => 'Proyecto\\EnfermeriaBundle\\Entity', 'SalonesBundle' => 'Proyecto\\SalonesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_89713526ce559c691b2a133e341db33ddf064b2d5c86c6a6e74ef78b76e61958');
    ...
    {
        $this->services['fos_elastica.client.default'] = $instance = new \FOS\ElasticaBundle\Elastica\Client(array('connections' => array(0 => array('host' => 'localhost', 'port' => 9200, 'logger' => 'fos_elastica.logger', 'headers' => array())), 'connectionStrategy' => 'Simple'), '');
    ...
    {
        return $this->services['fos_elastica.provider.app.usuarios'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.app.usuarios'), $this->get('fos_elastica.indexable'), 'Proyecto\\AdminBundle\\Entity\\Usuarios', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'app', 'typeName' => 'usuarios'), $this->get('doctrine'), $this->get('fos_elastica.slice_fetcher.orm'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57053845dde6e6.39377357')), true);
