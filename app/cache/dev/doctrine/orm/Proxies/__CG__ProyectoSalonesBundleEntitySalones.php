 ...
 */
class Salones extends \Proyecto\SalonesBundle\Entity\Salones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Proyecto\\SalonesBundle\\Entity\\Salones' . "\0" . 'id', '' . "\0" . 'Proyecto\\SalonesBundle\\Entity\\Salones' . "\0" . 'nombreSala', '' . "\0" . 'Proyecto\\SalonesBundle\\Entity\\Salones' . "\0" . 'descripcion', '' . "\0" . 'Proyecto\\SalonesBundle\\Entity\\Salones' . "\0" . 'psalas');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Salones $proxy) {
    ...
    public function setNombreSala($nombreSala)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNombreSala', array($nombreSala));

        return parent::setNombreSala($nombreSala);
    }
    ...
    public function getNombreSala()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNombreSala', array());

        return parent::getNombreSala();
    }
