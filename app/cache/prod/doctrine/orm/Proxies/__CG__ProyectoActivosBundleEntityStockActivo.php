 ...
 */
class StockActivo extends \Proyecto\ActivosBundle\Entity\StockActivo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Proyecto\\ActivosBundle\\Entity\\StockActivo' . "\0" . 'id', '' . "\0" . 'Proyecto\\ActivosBundle\\Entity\\StockActivo' . "\0" . 'cantidad', '' . "\0" . 'Proyecto\\ActivosBundle\\Entity\\StockActivo' . "\0" . 'eactivo', '' . "\0" . 'Proyecto\\ActivosBundle\\Entity\\StockActivo' . "\0" . 'pactivo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StockActivo $proxy) {
    ...
    public function setEactivo(\Proyecto\ActivosBundle\Entity\ElementosActivos $eactivo = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEactivo', array($eactivo));

        return parent::setEactivo($eactivo);
    }
    ...
    public function getEactivo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEactivo', array());

        return parent::getEactivo();
    }
