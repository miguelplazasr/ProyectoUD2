 ...
 */
class Dependencia extends \Proyecto\AdminBundle\Entity\Dependencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Proyecto\\AdminBundle\\Entity\\Dependencia' . "\0" . 'id', '' . "\0" . 'Proyecto\\AdminBundle\\Entity\\Dependencia' . "\0" . 'nombre', '' . "\0" . 'Proyecto\\AdminBundle\\Entity\\Dependencia' . "\0" . 'users');
        }
